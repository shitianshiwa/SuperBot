...
const bot = {
    socket: {
        send: {
            group: (msg, group_id, auto_escape = true) => {
            ...
            private: (msg, user_id, auto_escape = true) => {
                module.exports.stat.send++;
    ...
    http: {
        send: {
            group: async(msg, group_id, auto_escape = true) => {
                module.exports.stat.send++;
            ...
            private: async(msg, user_id, auto_escape = true) => {
                module.exports.stat.send++;
